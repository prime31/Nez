...
namespace Nez.OggSongImporter
{
	...
	public class OggSongProcessor : ContentProcessor<AudioContent, SongContent>
	{
		...
		private static readonly ConstructorInfo _songContentConstructor =
			typeof(SongContent).GetConstructor(BindingFlags.Instance | BindingFlags.NonPublic, null,
				new[] {typeof(string), typeof(TimeSpan)}, null);
