	...
	public class SpriteMime : RenderableComponent
	{
		...
		public override void render( Graphics graphics, Camera camera )
		{
			if( isVisibleFromCamera( camera ) )
				graphics.spriteBatch.Draw( _spriteToMime.subtexture, entity.transform.position + _localPosition, _spriteToMime.subtexture.sourceRect, color, entity.transform.rotation, _spriteToMime.origin, entity.transform.scale, _spriteToMime.spriteEffects, _layerDepth );
		}
	}
}
