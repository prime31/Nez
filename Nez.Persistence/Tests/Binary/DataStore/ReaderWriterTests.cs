...
namespace Nez.Persistence.Binary.Tests
{
    public class ReaderWriterTests
    {
        ...
        {
            Ass.AreEqual(reader.ReadString(), TestValues.aString);
            Ass.AreEqual(reader.ReadInt(), TestValues.aInt);
            Ass.AreEqual(reader.ReadUInt(), TestValues.aUint);
            Ass.AreEqual(reader.ReadFloat(), TestValues.aFloat);
            Ass.AreEqual(reader.ReadDouble(), TestValues.aDouble);
            Ass.AreEqual(reader.ReadBool(), TestValues.aBool);
        }
        ...
        {
            Ass.AreEqual(reader.ReadOptionalBool(), TestValues.aNullableBool);
