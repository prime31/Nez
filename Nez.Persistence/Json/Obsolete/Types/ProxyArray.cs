...
namespace Nez.Persistence
{
	public sealed class ProxyArray : Variant, IEnumerable<Variant>
	{
		...
		IEnumerator<Variant> IEnumerable<Variant>.GetEnumerator() => list.GetEnumerator();
		...
		internal bool CanBeMultiRankArray( int[] rankLengths ) => CanBeMultiRankArray( 0, rankLengths );
