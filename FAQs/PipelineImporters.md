Pipeline Importers
==========
Note: Pipeline importers are deprecated in favor of runtime loading of all assets. They will soon be removed so if you need them version 0.9.5 is the last version to contain them.

Nez provides a plethora of Pipeline Tool importers out of the box. Importers take data such as Tiled maps and convert them into a binary format that is much faster and more efficient to use at runtime. The following importers are available:
...
#### Pipeline Tool setup for access to the Nez Pipeline importers
