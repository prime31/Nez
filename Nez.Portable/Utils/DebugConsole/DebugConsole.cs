...
namespace Nez.Console
{
    public partial class DebugConsole
    {
            ...
            switch (key)
            {
                default:
                    if (key.ToString().Length == 1)
                    {
                        ...
                        {
                            _currentText = _currentText.Insert(_underscoreIndex, key.ToString());
                        }
                        else
                        {
                            _currentText = _currentText.Insert(_underscoreIndex, key.ToString().ToLower());
                        }
                    }
                    break;
                ...
                case (Keys.D1):
                    if (InputUtils.IsShiftDown())
                        _currentText = _currentText.Insert(_underscoreIndex, "!");
                    else
                        _currentText = _currentText.Insert(_underscoreIndex, "1");
                    break;
                case (Keys.D2):
                    if (InputUtils.IsShiftDown())
                        _currentText = _currentText.Insert(_underscoreIndex, "@");
                    else
                        _currentText = _currentText.Insert(_underscoreIndex, "2");
                    break;
                case (Keys.D3):
                    if (InputUtils.IsShiftDown())
                        _currentText = _currentText.Insert(_underscoreIndex, "#");
                    else
                        _currentText = _currentText.Insert(_underscoreIndex, "3");
                    break;
                case (Keys.D4):
                    if (InputUtils.IsShiftDown())
                        _currentText = _currentText.Insert(_underscoreIndex, "$");
                    else
                        _currentText = _currentText.Insert(_underscoreIndex, "4");
                    break;
                case (Keys.D5):
                    if (InputUtils.IsShiftDown())
                        _currentText = _currentText.Insert(_underscoreIndex, "%");
                    else
                        _currentText = _currentText.Insert(_underscoreIndex, "5");
                    break;
                case (Keys.D6):
                    if (InputUtils.IsShiftDown())
                        _currentText = _currentText.Insert(_underscoreIndex, "^");
                    else
                        _currentText = _currentText.Insert(_underscoreIndex, "6");
                    break;
                case (Keys.D7):
                    if (InputUtils.IsShiftDown())
                        _currentText = _currentText.Insert(_underscoreIndex, "&");
                    else
                        _currentText = _currentText.Insert(_underscoreIndex, "7");
                    break;
                case (Keys.D8):
                    if (InputUtils.IsShiftDown())
                        _currentText = _currentText.Insert(_underscoreIndex, "*");
                    else
                        _currentText = _currentText.Insert(_underscoreIndex, "8");
                    break;
                case (Keys.D9):
                    if (InputUtils.IsShiftDown())
                        _currentText = _currentText.Insert(_underscoreIndex, "(");
                    else
                        _currentText = _currentText.Insert(_underscoreIndex, "9");
                    break;
                case (Keys.D0):
                    if (InputUtils.IsShiftDown())
                        _currentText = _currentText.Insert(_underscoreIndex, ")");
                    else
                        _currentText = _currentText.Insert(_underscoreIndex, "0");
                    break;
                case (Keys.OemComma):
                    if (InputUtils.IsShiftDown())
                        _currentText = _currentText.Insert(_underscoreIndex, "<");
                ...
                case Keys.OemMinus:
                    if (InputUtils.IsShiftDown())
                        _currentText = _currentText.Insert(_underscoreIndex, "_");
                    else
                        _currentText = _currentText.Insert(_underscoreIndex, "-");
                    break;
                case Keys.OemPlus:
                ...
                case Keys.Space:
                    ...
                    break;
                case Keys.Back:
                    if (_currentText.Length > 0 && _underscoreIndex > 0)
                    {
                        _currentText = _currentText.Remove(_underscoreIndex - 1, 1);
                        _underscoreIndex -= 2;
                    }
                    break;
                case Keys.Delete:
                ...
                case Keys.Down:
                    ...
                    break;
                case Keys.Left:
                    _underscoreIndex = Math.Max(_underscoreIndex - 1, 0);
                    break;
                case Keys.Right:
                    _underscoreIndex = Math.Min(_underscoreIndex + 1, _currentText.Length - 1);
                    break;
                case Keys.Tab:
                    if (InputUtils.IsShiftDown())
                    {
                    ...
                    if (_tabIndex != -1)
                    {
                        ...
                        _underscoreIndex = _currentText.Length;
                    }
        ...
        internal void Render()
        {
            ...
            if (_underscore)
            {
                commandLineString = commandLineString.Insert(_underscoreIndex + 2, "|");
            }
