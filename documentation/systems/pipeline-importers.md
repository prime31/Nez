---
layout: docs
permalink: /documentation/systems/pipeline-importers
---
...
## UI Skin
Imports uiskin files which are JSON files that define the varies styles for UI elements. See the [UI page](/documentation/systems/nez-ui) for details on the file format and an example.
